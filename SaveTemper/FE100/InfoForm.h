...
namespace FE100 {
	...
	private:
		...
		void InitializeMyComponent(void)
		{
			...
			listZak->Add("under_the_lazy_sky");
			listZak->Add("under_the_lazy_sky");
			listZak->Add("under_the_lazy_sky");
			...
			String^ zak1 = "Under the lazy sky by I.R.on (WiiCrazy)";
			...
			nameListZak->Add("BAG by I.R.on (WiiCrazy)");
			nameListZak->Add("Zigzag by I.R.on (WiiCrazy)");
